...
<head>
<title>태인이네영화관(관리자)-영화별예매율통계</title>
<meta charset="utf-8">
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" onclick="location.href='/admin/statistic/movieVol'">&times;</button>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" onclick="location.href='/admin/statistic/movieVol'">확인</button>
				</div>
			</div>
		</div>
	</div>
...
<table id="stickTable" class="table table-hover">
	<tr>
		<th class="info">영화</th>
		<c:forEach var="movieReservations" items="${movieVol}">
			<th class="info">${movieReservations.movie}</th>
		</c:forEach>
	</tr>
	<tr>
		<th class="danger">예매수</th>
		<c:forEach var="movieReservations" items="${movieVol}">
			<th>${movieReservations.resCount}</th>
		</c:forEach>
	</tr>
</table>
	<div id="excelSave">
